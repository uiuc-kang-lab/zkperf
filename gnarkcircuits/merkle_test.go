...
func TestMerklePlonkBLS(t *testing.T) {
	assert := test.NewAssert(t)
...
func TestMerkleGroth16BN254(t *testing.T) {
	assert := test.NewAssert(t)
...
func TestMerkleGroth16BLS(t *testing.T) {
	assert := test.NewAssert(t)
