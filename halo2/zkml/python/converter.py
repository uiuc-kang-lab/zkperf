...
class Converter:
  def __init__(
      self, model_path, scale_factor, k, num_cols, num_witness_cols, num_randoms, use_selectors, commit,
      expose_output
    ):
    ...
    self.num_witness_cols = num_witness_cols
  ...
  def to_dict(self, start_layer, end_layer):
    ...
    d = {
      ...
      'num_witness_cols': self.num_witness_cols,
...
def main():
  ...
  parser.add_argument('--num_witness_cols', type=int, default=3)
