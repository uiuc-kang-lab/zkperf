...
pub const SMALLER_TABLE: [u32; 8] = [2, 24, 56, 100, 128, 16, 20, 49];
...
impl<F: RichField + Extendable<D>, const D: usize> CircuitBuilder<F, D> {
    ...
    pub fn add_lookup_table_from_table(&mut self, inps: &[u32], outs: &[u32]) -> usize {
    ...
    pub fn add_lookup_table_from_fn(&mut self, f: fn(u32) -> u32, inputs: &[u32]) -> usize {
