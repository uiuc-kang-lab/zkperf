...
impl<F: RichField + Extendable<D>, const D: usize> CircuitBuilder<F, D> {
    ...
    pub fn update_luts_from_fn(&mut self, f: fn(u32) -> u32, inputs: &[u32]) -> usize {
        let lut = Arc::new(Self::get_lut_from_fn::<u32>(f, inputs));
    ...
    pub fn update_luts_from_table(&mut self, inputs: &[u32], table: &[u32]) -> usize {
        assert!(
