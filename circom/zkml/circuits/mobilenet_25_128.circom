...
include "../lib/Conv2D_DW_ReLU.circom";
include "../lib/MN_Conv2D_ReLU.circom";
include "../lib/AveragePooling2D.circom";

template mobilenet_v1_25_128_relu() {
    ...
    component conv2d_0 = MN_Conv2D_ReLU(128, 128, 3, 16, 3, 2);
    component conv2d_dw_1 = Conv2D_DW_ReLU(64, 64, 16, 3, 1);
...
component main = mobilenet_v1_25_128_relu();